...
const randomizerValidation = () => {
    if(studentsArray.length == 0) {
        ...
        errorText.innerText = 'The list must contain at least 4 students before randomizing!'
        errorText.style.transform = 'translateY(0)';
        setTimeout(() => {
            errorText.style.transform = 'translateY(100px)'
        }, 3000);
...
let deleteStudent = (e) => {
    ...
    let deleteStudent = studentsArray.findIndex(element => element.id == studentID);
...
let editStudent = (e) => {
    if(buttonMethod === 'add'){
        ...
        let editStudentName = studentsArray.find(element => element.id == studentID).studentName;
        ...
        let editStudentIndex = studentsArray.findIndex(element => element.id == studentID);
        studentsArray.splice(editStudentIndex, 1, {id: studentID, studentName: input.value});
...
const randomizer_Animation = () => {
    ...
    if(randomizerValidation()){
        ...
        randomizer_AnimationInterval = setInterval(randomizer_AnimationInterval, 100);
